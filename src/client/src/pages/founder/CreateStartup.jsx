      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="bg-[#11141C] rounded-2xl border border-[#232735] p-6 sm:p-10 shadow-xl">
          <div className="mb-8 pb-6 border-b border-[#232735]">
            ...
            <h1 className="text-2xl font-bold text-white tracking-tight">Create New Startup</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl border border-[#2A2F42] bg-[#171A24] text-sm text-white placeholder:text-slate-500 focus:outline-hidden focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 transition"
              />
              <span className="text-[11px] text-slate-500 mt-1 block">Maximum 100 characters</span>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl border border-[#2A2F42] bg-[#171A24] text-sm text-white placeholder:text-slate-500 focus:outline-hidden focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 transition"
              />
              <span className="text-[11px] text-slate-500 mt-1 block">One-line elevator pitch (max 200 characters)</span>
            </div>
              ...
              <div>
                ...
                {customIndustry === 'Other' && (
                  <input
                    ...
                    className="w-full mt-2 px-4 py-2 rounded-xl border border-[#2A2F42] bg-[#171A24] text-sm text-white placeholder:text-slate-500 focus:outline-hidden focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 transition"
                  />
                )}
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full px-4 py-2.5 rounded-xl border border-[#2A2F42] bg-[#171A24] text-sm text-white placeholder:text-slate-500 focus:outline-hidden focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 transition leading-relaxed"
              />
            </div>
