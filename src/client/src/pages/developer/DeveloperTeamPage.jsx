...
import { getDepartmentIconComponent } from '../founder/DepartmentWorkspacePage';
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="bg-[#11141C] rounded-2xl border border-[#232735] p-6 sm:p-8 shadow-xl space-y-6">
          ...
          {/* ====================================================
              ...
              ==================================================== */}
          <div className="pt-4 border-t border-[#232735] space-y-4">
            <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5 sm:gap-4">
              {departments.map((dept) => {
                ...
                return (
                  <Link
                    key={deptId}
                    to={`/developer/startups/${startupId}/departments/${deptId}`}
                    className="group relative p-4 rounded-xl bg-[#171A24] border border-[#2A2F42] hover:border-indigo-500/60 hover:bg-[#1C202C] transition-all duration-200 shadow-sm hover:shadow-indigo-500/10 hover:-translate-y-0.5 flex flex-col justify-between space-y-3 cursor-pointer"
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="w-10 h-10 rounded-xl bg-indigo-950/60 border border-indigo-800/60 text-indigo-400 group-hover:text-indigo-300 group-hover:bg-indigo-900/60 transition flex items-center justify-center shrink-0">
                        <DeptCardIcon className="w-5 h-5" />
                      </div>
          ...
          {/* Department Sections */}
          <div className="space-y-6 pt-4 border-t border-[#232735]">
            {departments.map((dept) => {
              const deptId = dept._id || dept.id;
              const deptMembers = deptMembersMap[deptId] || [];
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between border-b border-[#232735]/80 pb-3">
                    ...
                    <Link
                      to={`/developer/startups/${startupId}/departments/${deptId}`}
                      className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-semibold text-indigo-300 bg-indigo-950/40 hover:bg-indigo-900/60 border border-indigo-800/40 transition cursor-pointer shrink-0"
                    >
